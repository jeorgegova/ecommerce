...
INSERT INTO settings (key, value, description) VALUES
  ...
  ('low_stock_threshold','5',                                            'Umbral para alerta de stock bajo'),
  ('stock_bar_max',       '20',                                           'Tope visual de la barra de stock'),
  ('quick_adjust_amounts','[1,5,10]',                                     'Cantidades para botones de ajuste rápido'),
