    ...
    <div className="relative w-full overflow-hidden bg-gray-100">
      ...
      >
        ...
        {(banner.title || banner.subtitle || banner.link_text) && (
          <div className="absolute inset-0 flex flex-col justify-center bg-gradient-to-r from-black/50 to-transparent">
            <div className="mx-auto w-full max-w-7xl px-6 sm:px-12">
              ...
              {banner.link_text && banner.link_url && (
                <span className={`inline-flex w-fit rounded-full bg-white px-4 py-2 text-xs font-semibold text-gray-900 transition-colors hover:bg-gray-100 sm:text-sm ${banner.title || banner.subtitle ? "mt-3 sm:mt-4" : ""}`}>
                  {banner.link_text}
                </span>
              )}
            </div>
