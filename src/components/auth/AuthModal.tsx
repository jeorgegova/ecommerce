  ...
  return (
    ...
    >
      <motion.div className="mb-6 flex items-center gap-3 lg:hidden">
        <img src="/logoamelattecuadrado.png" alt="Amelatte" className="h-8 w-8 object-contain" />
        <span className="text-lg font-extrabold tracking-tight text-gray-900">Amelatte</span>
      </motion.div>
  ...
  return (
    ...
    >
      ...
      <motion.div custom={0} variants={stagger} initial="hidden" animate="visible" className="mb-8">
        ...
        <p className="text-[15px] text-gray-500 leading-relaxed">
          Únete a Amelatte y comienza a comprar repuestos para tus máquinas.
        </p>
      </motion.div>
